...
public class Consulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(40, 106, 150, 47);
    ...
    private void Botao_buscarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            String query = "SELECT * FROM produto WHERE nome_produto LIKE '%" + termoBusca + "%'";
            ...
            while (resultSet.next()) {
                ...
                resultado.append("Nome do fornecedor : ").append(fornecedor).append("\n");
                contador++;
